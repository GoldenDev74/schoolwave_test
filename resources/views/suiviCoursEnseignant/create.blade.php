...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>
                        {{ isset($isEdit) ? 'Modifier le' : 'Créer un' }} Suivi de Cours
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            @else
                {!! Form::open(['route' => 'suiviCoursEnseignant.store']) !!}
            @endif
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::select('affection_matiere', $affectationMatieres, null, ['class' => 'form-control', 'required', 'placeholder' => 'Sélectionnez une classe et matière']) !!}
                    </div>
                </div>
            </div>
